...
def get_node_embeddings(nodes, model_name, batch_size=24):
    ...
    for batch in tqdm(batches, total=len(nodes) // batch_size + 1):
        input = tokenizer(list(map(lambda x: x, batch)), 
...
if __name__ == '__main__':
    ...
    node_embeddings = get_node_embeddings(text_nodes, args.model, args.batch_size)
